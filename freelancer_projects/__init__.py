...
def freelancer_bid(driver, details, url, budget, days):
    ...
    # BD button #1
    WebDriverWait(driver, 15).until(lambda driver: driver.find_element_by_xpath("//a[@class='btn btn-info btn-large bidButton']"))
    ...
    WebDriverWait(driver, 15).until(lambda driver: driver.find_element_by_xpath("//button[@id='place-bid-step2']"))
    driver.find_element_by_xpath("//button[@id='place-bid-step2']").click()
    # WebDriverWait(driver, 15).until(lambda driver: driver.find_element_by_xpath("//a[@class='btn btn-large btn-primary align-c margin-t10 repostProjectButton']"))
